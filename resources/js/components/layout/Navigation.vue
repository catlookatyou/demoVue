<template>
    <aside class="md:w-1/4 md:pt-8">
        <section class="mb-10">
            <div class="fixed flex flex-col rounded-full border border-gray-900 text-gray-900 h-8 w-8 md:hidden" style="top:90%; right:3%">
                <button @click="navToggle" id="toggle">
                    ...
                </button>
            </div>
